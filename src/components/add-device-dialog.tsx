...
import { BluetoothSearching, Bluetooth } from "lucide-react"
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2 h-fit max-h-[420px] overflow-y-scroll">
            ...
            {availableDevices.map((device) => (
              <Card key={device.id} className="cursor-pointer bg-black/10 backdrop-blur-xl border border-black/20 text-slate-200" onClick={() => handleAddDevice(device)}>
