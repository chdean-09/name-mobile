          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className={`p-6 rounded-3xl border-2 cursor-pointer transition-all ${scheduleType === "lock"
              ...
              >
                <div className="text-center space-y-3">
                  <div
                    className={`w-16 h-16 mx-auto rounded-2xl flex items-center justify-center ${scheduleType === "lock" ? "bg-red-500" : "bg-slate-200 dark:bg-slate-700"
                      }`}
                  >
              ...
              <motion.div
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className={`p-6 rounded-3xl border-2 cursor-pointer transition-all ${scheduleType === "unlock"
              ...
              >
                <div className="text-center space-y-3">
                  <div
                    className={`w-16 h-16 mx-auto rounded-2xl flex items-center justify-center ${scheduleType === "unlock" ? "bg-green-500" : "bg-slate-200 dark:bg-slate-700"
                      }`}
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              <motion.div
                ...
                className={`inline-flex items-center gap-3 p-6 rounded-3xl ${scheduleType === "lock" ? "bg-red-50 dark:bg-red-950" : "bg-green-50 dark:bg-green-950"
                  }`}
              >
                <div
                  className={`w-12 h-12 rounded-2xl flex items-center justify-center ${scheduleType === "lock" ? "bg-red-500" : "bg-green-500"
                    }`}
                >
                  {scheduleType === "lock" ? (
            ...
            <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-inner">
              <TimePickerWheel value={selectedTime} onChange={setSelectedTime} className="w-full" />
            </div>
          </div>
        )
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              {DAYS.map((day) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className={`p-4 rounded-2xl border-2 cursor-pointer transition-all ${selectedDays.includes(day.short)
                    ? scheduleType === "lock"
                      ? "border-red-500 bg-red-50 dark:bg-red-950"
                      : "border-green-500 bg-green-50 dark:bg-green-950"
                    : "border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800"
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    {selectedDays.includes(day.short) && (
                      <div
                        className={`w-6 h-6 rounded-full flex items-center justify-center ${scheduleType === "lock" ? "bg-red-500" : "bg-green-500"
                          }`}
                      >
            ...
            {selectedDays.length > 0 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="text-center">
                <Badge
                  variant="secondary"
                  className={`text-sm px-4 py-2 ${scheduleType === "lock"
        ...
        return (
          <div className="space-y-6">
            ...
            <motion.div
              ...
              className={`p-6 rounded-3xl border-2 ${scheduleType === "lock"
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div
                  className={`w-16 h-16 rounded-2xl flex items-center justify-center ${scheduleType === "lock" ? "bg-red-500" : "bg-green-500"
                    }`}
                >
                  {scheduleType === "lock" ? (
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {/* Content */}
            <div className={`flex-1 p-6 overflow-y-auto ${keyboardOpen ? "max-h-[40vh]" : ""}`}>{renderStep()}</div>
            ...
            <div className="p-6 border-t border-slate-100 dark:border-slate-800">
              <div className="flex items-center justify-between">
                ...
                <Button
                  onClick={nextStep}
                  disabled={!canProceed()}
                  className={`rounded-2xl ${scheduleType === "lock"
